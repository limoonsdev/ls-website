...
export default function Home() {
  ...
  const [stats, setStats] = useState({ users: '...', services: '...', generated: '...' });
  ...
  useEffect(() => {
    fetch('/api-bot/stats')
      ...
      .catch(() => {
        setStats({ users: '2,400+', services: '40', generated: '50,000+' });
      });
  }, []);
  ...
  return (
    <>
      ...
      <main className="landing-page">
        ...
        <button onClick={handleConnect} className="discord-btn">
        ...
        <div className="stats-container">
          <div className="stat-pill">
            <span>{t('landing_users')}</span>
            <span className="stat-value">{stats.users}</span>
          </div>
          <div className="stat-dot"></div>
          <div className="stat-pill">
            <span>{t('landing_services')}</span>
            <span className="stat-value">{stats.services}</span>
          </div>
          <div className="stat-dot"></div>
          <div className="stat-pill">
            <span>{t('landing_generated')}</span>
